...
<link rel="manifest" href="../../survey-runtime/inst/www/manifest.json" />
<meta name="theme-color" content="#007bff" />
<meta name="apple-mobile-web-app-capable" content="yes" />
<meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />

<script src="../../survey-runtime/inst/www/indexeddb.js"></script>
...
observeEvent(input$submit, {
  ...
  validations <- list(
    name = nf_validate(input$name, rules = list(required = TRUE, type = "text"),
                       question_label = "Name"),
    age = nf_validate(input$age,
                      rules = list(required = TRUE, type = "numeric", min = 0, max = 120),
                      question_label = "Age"),
    gender = nf_validate(input$gender, rules = list(required = TRUE),
                         question_label = "Gender"),
    country = nf_validate(input$country, rules = list(required = TRUE),
                          question_label = "Country"),
    residence = nf_validate(input$residence, rules = list(required = TRUE),
                            question_label = "Residence")
  )
  ...
  if (any(errors)) {
    ...
    error_messages <- unlist(lapply(validations[errors], function(v) v$errors[[1]]))
...
<div style="text-align: center; color: #6b7280; padding: 2rem 0;">
  <p>Powered by <strong>NomadForms</strong> 📱🌍</p>
